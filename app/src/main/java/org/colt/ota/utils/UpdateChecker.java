...
import org.colt.ota.UpdaterApplication;
import org.colt.ota.activities.UpdaterActivity;
import org.colt.ota.misc.Constants;
import org.colt.ota.misc.State;
import org.colt.ota.misc.UpdateInfo;
import org.colt.ota.requests.UpdatesJsonObjectRequest;
import org.colt.ota.service.UpdateCheckService;
...
public class UpdateChecker implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "org.colt.ota.action.UPDATE_CHECK_FINISHED";
