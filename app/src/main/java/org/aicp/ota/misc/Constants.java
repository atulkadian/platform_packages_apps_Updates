 ...
 */
package org.aicp.ota.misc;

import android.app.AlarmManager;

public class Constants {
    // Download related
    public static final String UPDATES_FOLDER = "AICP-Updates";
    public static final String DOWNLOAD_ID = "download_id";
    public static final String DOWNLOAD_NAME = "download_name";
    public static final String DOWNLOAD_TMP_EXT = ".tmp";
    public static final String DOWNLOAD_CHANNEL_ID = "org.aicp.ota.DOWNLOAD_CHANNEL";
    public static final String DOWNLOADING_CHANNEL_ID = "org.aicp.ota.DOWNLOADING_CHANNEL";
    // Preferences
    ...
    // Build vars
    public static final String CURRENT_DEVICE_NAME = "ro.aicp.device";
    public static final String CURRENT_VERSION = "ro.aicp.version";
    public static final String OTA_URL = "https://raw.githubusercontent.com/AtulKadian/AICP_OTA/p9.0/%s.json";
